...
4. 将 `main.js`、`manifest.json`、`styles.css` 复制到 Vault 的 `.obsidian/plugins/obsidian-sync-webdav/` 目录
...
构建产物 `main.js` 会输出到项目根目录，将其与 `manifest.json`、`styles.css` 一同复制到 `.obsidian/plugins/obsidian-sync-webdav/` 即可。
...
4. Copy `main.js`, `manifest.json`, `styles.css` to `.obsidian/plugins/obsidian-sync-webdav/` inside your vault
...
Copy `main.js`, `manifest.json`, `styles.css` to `.obsidian/plugins/obsidian-sync-webdav/`.
